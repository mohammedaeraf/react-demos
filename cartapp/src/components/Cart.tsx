 ...
 * It shows each item's name, quantity, and total price, as well as the overall cart total.
 * If the cart is empty, it displays an informational message.
 * The user can proceed to the address page to continue checkout.
 */
